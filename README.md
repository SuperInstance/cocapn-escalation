...
CoCapn escalation engine — dynamic tier routing, budget tracking, device rebalancing, JEPA-lite prediction
...
```bash
git clone https://github.com/SuperInstance/cocapn-escalation
cd cocapn-escalation
```
